...
#[cfg_attr(feature = "openapi", schema(
    description = "IronShield challenge response containing the solved challenge and proof-of-work solution",
    example = json!({
        "solved_challenge": {
...
pub struct IronShieldChallengeResponse {
    /// The complete original IronShield challenge that was solved
    pub solved_challenge: IronShieldChallenge,
    /// The nonce solution found by the proof-of-work algorithm
    #[cfg_attr(feature = "openapi", schema(example = 187453i64))]
    pub solution:         i64,
}
